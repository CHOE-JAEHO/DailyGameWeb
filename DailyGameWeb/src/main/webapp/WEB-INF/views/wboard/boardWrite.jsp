...
<body>
	...
	<table id="WBtable">
		...
		<tr>
		<td colspan="2" class="WBTD2"><input class="BWbtn" type="submit" value="글쓰기">  <a onclick="wback()"><input class="BWbtn" id="back" type="button" value="취소" ></a></td>
